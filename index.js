...
const homePage = `
<div class="row">
    <div id="home-page" class="col-12">
    <title>Home</title>
    <div class="row">
        <form id="pet-form" class="col-3 justify-content-center">
        <label for="zipcode"></label>
        <input id="zipcode" placeholder="ZipCode">
        <label for="pet-type"></label>
        <select id="pet-type">
        <option value="">Select Animal</option>
        <option value="barnyard">Barnyard Animal</option>
        ...
        <label for="sex"></label>
        <input type="radio" name="sex" id= "sex-m-f "value="M">
     ...
     <div class="row">
        <div class="col-4">
            <img src="https://d30y9cdsu7xlg0.cloudfront.net/png/464184-200.png" alt-text="paw and dog bone image">
        </div>
        <div class="col-4">
            <img src="https://d30y9cdsu7xlg0.cloudfront.net/png/582073-200.png" alt-text="right pointing arrow">
        </div>
        <div class="col-4">
            <img src="https://d30y9cdsu7xlg0.cloudfront.net/png/1124785-200.png" alt-text="house icon">
        </div>
    </div>
    <p class="app-info"> Adopt a Friend is an app to help you find adoptable pets near your location. </p>
</div>
</div>
<div class="row">
    ...
    <div id="single-pet-page" class="hidden">
        <p class="pet-info"></p>
        <div id="large-image"></div>
        <div id="map"></div>
    </div>
    <footer id="restart" class="col-12">
        <p>About me: My name is Tatiana M.R. Johnson and I am a student in Thinkful's Full Stack Web Development program.</p>
        <p>I am new to programming, but I love storytelling and I am excited to learn how I can use programming to tell compelling stories.</p>
    </footer>
</div>`;
